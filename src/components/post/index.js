...
const Post = ({ posts }) => {
  ...
  return (
    <div className="">
      {post.map((item, index) => (
        <div className="bg-white w-full mt-5 p-3 mb-5 mb-4" key={index}>
          <div className="flex">
          ...
          <div className="flex gap-6 mt-4">
            <div className="relative">
              ...
              >
                {userLike[item._id].some(
                  ...
                  <FontAwesomeIcon
                    // onClick={() => handleSendNotification(1, item._id, item.user)}
                    onClick={() =>
            ...
            <div className="relative">
              <button>
                <FontAwesomeIcon className="text-cyan-500" icon={faComment} />
              </button>
                  ...
                  {comments[item._id].map((itemComment, index) => (
                    <li className="flex mb-3" key={index}>
                      <img
                        ...
                        src={
                          itemComment.user.image !== ""
                            ? itemComment.user.image
                            : "https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcQssqDqtb8e2Xu3B44Nxoir1bFp2o4dq_VouQ&s"
                        }
                        alt=""
                      />
                            ...
                            <div className="relative">
                              ...
                              {option[itemComment._id] && (
                                <button
                                  ...
                                  onClick={() => {
                                    deleteComment(itemComment._id, item._id);
                                  }}
                                >
                                  Xóa
                                </button>
          ...
          <div>
            <div className="flex gap-2 mt-4">
              <div className="rounded-full w-[30px] h-[30px] flex-2">
                <img
                  className="w-full h-full rounded-full"
                  src={userData.image}
                  alt=""
              ...
              <textarea
                ...
                className="bg-slate-200 resize-none outline-0 p-2 text-sm rounded-lg flex-1 "
